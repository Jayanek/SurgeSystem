...
public partial class SakilaContext : DbContext
{
    ...
    //    => optionsBuilder.UseMySql("server=localhost;user id=root;password=Fit60172662$;database=sakila", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.32-mysql"), x => x.UseNetTopologySuite());
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            ...
            entity.Property(e => e.Location)
                .HasAnnotation("MySql:SpatialReferenceSystemId", 0)
